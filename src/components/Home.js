      ...
      <div className='container-fluid'>
       <div className='d-sm-flex align-items-center justify-content-between'>
          <div className='ms-sm-5 ps-sm-5 d-flex flex-column text-center align-items-center align-items-lg-start'>
            <h1 className=''>Hi, I'm Bhavan Sai</h1>
            <h1 className='fw-bold custom-font'>Associate Software Engineer.</h1>
            <p className='pt-5'>DevOps Engineer / Frontend Development </p>
